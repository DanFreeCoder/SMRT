...
while ($row = $reminders->fetch(PDO::FETCH_ASSOC)) {
    ...
    echo '
        <li class="list-group-item list-group-item-action d-flex justify-content-between"><a href="#" class="reminderList" value="' . $id . '" style="color:black; text-decoration:none; width:70%;">' . $title . '</a><span id="dayhtml">' . $dayhtml . '</span>
        <i class="fa-regular fa-circle-xmark text-danger remove" value="' . $id . '"></i></li>
    ';
}
